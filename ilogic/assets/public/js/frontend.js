...
jQuery(document).ready(function ($) {
  ...
  var siTrigger = $('.si_trigger');
  var slide = $('.il_slidein');
  var siContainer = $('.si_container');
  var siClose = $('.si_close');
  var siSlide = function siSlide(e) {
    e.preventDefault();
    var current = $(e.currentTarget);
    var currentIndex = current.data('index');
    var slides = current.closest(siContainer).find(slide);
    var triggers = current.closest(siContainer).find(siTrigger);
  ...
  siSlideDown = function siSlideDown(e) {
    e.preventDefault();
    var current = $(e.currentTarget);
    var slides = current.closest(siContainer).find(slide);
    var triggers = current.closest(siContainer).find(siTrigger);
